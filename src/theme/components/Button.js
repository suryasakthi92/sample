...
export default (variables = variable) => {
    ...
    const buttonTheme = {
        ...
        ".white": ButtonTheme.whiteBordered,
        ...
        ".transparent": {
            ...
            ".white": ButtonTheme.whiteTransparent,
            ".success": {
                "NativeBase.Text": {
                    color: variables.btnSuccessBg,
                },
        ...
        ".nsabutton": ButtonTheme.nsabutton,
        ".disableButtonBackground": ButtonTheme.disableButtonBackground,
        ".orange": {
            backgroundColor: '#F97545'
        },
        ".send": {
            alignSelf: "flex-end",
            marginTop: 5,
